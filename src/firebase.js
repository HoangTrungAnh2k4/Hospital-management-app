...
export { database, addMedicine, getMedicine, deleteMedicine, queryByFirstChar, updateMedicine, addWinBidMedicine, deleteWinBidMedicine, queryMedByName, queryMedBCatOrAct};
